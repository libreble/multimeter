// Fixture test. Frames are REAL 6-byte captures extracted from the open-source `Bluetooth-DMM-For-Windows` project's
...
describe('owon-plus decode (real frames from the open-source Bluetooth-DMM-For-Windows TestData dev_type 6)', () => {
  ...
  it('surfaces the hold/rel/auto/bat/min mode flags (OWON app LSB-first Status order)', () => {
    ...
    // Flag n is at bit n: bits 0..4 (hold/rel/auto/bat/min)
    // set, bit 5 (max) clear.
