...
// the open-source `Bluetooth-DMM-For-Windows` project's `Binary raw data.md` (BDM dev_type-0, 11-byte frames). See drivers/bdm.ts.
...
describe('bdm decode (real frames from the open-source Bluetooth-DMM-For-Windows project)', () => {
