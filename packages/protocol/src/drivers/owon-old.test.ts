...
// extracted from the open-source `Bluetooth-DMM-For-Windows` project's `TestData(dev_type == 5, …)` in Utilities.cs — the
...
describe('owon-old decode (real frames from the open-source Bluetooth-DMM-For-Windows TestData dev_type==5)', () => {
...
// App-verified regressions: the vendor OWON app reads byte6 as an
