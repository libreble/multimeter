// AICARE driver — the "AICARE" clamp-meter family (DevType 3 in the open-source `Bluetooth-DMM-For-Windows` project's GATT table,
// GATT service 0xFFB0). Covers the AICARE AP-570C-APP Bluetooth clamp meter and rebadges.
//
