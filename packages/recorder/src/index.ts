// @libreble/multimeter-recorder — browser, Bluetooth-independent recording layer for BLE
...
// @libreble/multimeter-protocol; consumed by the React/Vue bindings and the app.
