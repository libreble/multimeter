// SessionsStore — framework-agnostic backing for the Sessions list: browse
...
import { toCsv, type CsvChannel, type Reading, type Session } from '@libreble/multimeter-protocol';
...
// IndexedDB, all channels merge-sorted chronologically. Shared by
